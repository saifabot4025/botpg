import { getCuteDynamicReply } from "../utils/cuteReplies.js";
import { staffNames } from "../utils/staffNames.js";
import { getUserState, setUserState, clearUserState } from "../utils/stateManager.js";
    ...
    switch (buttonData) {
      case "register_admin":
        ...
        replyMessages.push({
          ...
          text: await getCuteDynamicReply(
            "รบกวนพิมพ์ชื่อ-นามสกุล เบอร์โทร บัญชีหรือวอเลท และไอดีไลน์ด้วยนะคะ ข้อมูลครบจะดำเนินการให้ทันทีเลยค่า 💕"
          ),
        });
        break;
      ...
      case "issue_deposit":
        ...
        replyMessages.push({
          type: "text",
          text: await getCuteDynamicReply(
            "พี่รบกวนแจ้งชื่อ+เบอร์โทร และส่งรูปสลิปด้วยนะคะ เดี๋ยวน้องจะรีบดูแลให้เลยค่า 💕"
          ),
        });
        break;
...
/**
 * ✅ ฟังก์ชันสร้างรีวิวยอดถอนแบบสุ่ม
 */
